...
import { deletePR } from '@/db/operations'
              ...
              {sorted.map((pr) => (
                <li key={pr.exerciseName} className="flex items-center gap-2 py-3">
                  ...
                  <button
                    ...
                    className="text-white/45 hover:text-pink-300 tap-target"
                  >
                  ...
                  <button
                    onClick={() => {
                      if (confirm(`Delete the PR for ${pr.exerciseName}?`)) {
                        deletePR(pr.exerciseName)
                      }
                    }}
                    aria-label="Delete PR"
                    title="Delete PR"
                    className="text-white/35 hover:text-red-300 tap-target -mr-1"
                  >
